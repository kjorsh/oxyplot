...
namespace OxyPlot.Series
{
    ...
    public class LineSeries : DataPointSeries
    {
        ...
        protected virtual void RenderLine(IRenderContext rc, OxyRect clippingRect, IList<ScreenPoint> pointsToRender)
        {
            ...
            rc.DrawClippedLine(clippingRect, pointsToRender, this.MinimumSegmentLength * this.MinimumSegmentLength, this.GetSelectableColor(this.ActualColor), this.StrokeThickness, dashArray, this.LineJoin, this.StrokeThickness<2, this.outputBuffer);
        }
